...
class ToolExecutor:
    ...
    def _orch_deps(self) -> OrchestrationDeps:
    ...
    async def _orchestrate_vote(self, func_args: dict, workspace: str) -> str:
        return await _orch.vote(self._orch_deps(), func_args, workspace)

    async def _orchestrate_map_reduce(self, func_args: dict, workspace: str) -> str:
        return await _orch.map_reduce(self._orch_deps(), func_args, workspace)

    async def _orchestrate_chain(self, func_args: dict, workspace: str) -> str:
        return await _orch.chain(self._orch_deps(), func_args, workspace)

    async def _orchestrate_dag(self, func_args: dict, workspace: str) -> str:
        return await _orch.dag(self._orch_deps(), func_args, workspace)
