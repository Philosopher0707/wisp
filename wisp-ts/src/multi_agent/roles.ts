...
Rules:
- You have access to the tools listed in "Tools available" below — use only those, don't hallucinate others (run_bash etc. may be absent in restricted modes; use list_files/read_file for exploring).
